...
public class ArmorUndeadMobEffect extends StatusEffect {
    protected ArmorUndeadMobEffect() {
    ...
    public boolean applyUpdateEffect(ServerWorld world, LivingEntity entity, int amplifier) {
        ...
        StatusEffectInstance armorEffectInstance = entity.getStatusEffect(ModEffects.ARMOR_UNDEAD_MOB_DEBUFF);
